...
class Mars {
  ...
  getDispatchedThings() {
    return this.#dispatchedThings.slice();
  }

  cancel(id) {
    this.#dispatchedThings.splice(this.#dispatchedThings.indexOf(this.#dispatchedThings.find(e => e.id === id)), 1);
  }
}
